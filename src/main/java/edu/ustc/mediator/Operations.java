...
import edu.ustc.audio.FormatControlConf;
import edu.ustc.audio.PreProcess;
import edu.ustc.audio.WaveData;
import edu.ustc.audio.feature.FeatureVector;
import edu.ustc.classify.speech.HiddenMarkov;
import edu.ustc.classify.speech.vq.Codebook;
import edu.ustc.classify.speech.vq.Points;
...
public class Operations {
	...
	double test0[][] = // user0
	{ { 1.0, 2.5, 5.0, 10, 3.0, 8.0, 4.0, 45.0 }, { 1.0, 2.0, 4.0, 10, 3.0, 9.0, 3.5, 52.0 },
			{ 1.0, 2.2, 5.0, 11, 3.0, 9.0, 4.0, 52.0 }, { 1.0, 3.0, 5.0, 9, 3.0, 10.0, 3.1, 51.0 },
			{ 1.0, 2.0, 6.0, 10, 3.0, 9.0, 4.0, 54.0 }, { 1.0, 2.2, 5.0, 12, 3.0, 8.0, 4.0, 52.0 } };
	double test1[][] = // user1
	{ { 2.0, 2.5, 5.0, 20, 3.0, 18.0, 4.0, 150.0 }, { 2.0, 2.0, 4.0, 19, 3.0, 19.0, 3.5, 142.0 },
			{ 2.0, 2.5, 5.0, 20, 3.0, 19.0, 4.0, 150.0 }, { 2.0, 3.0, 5.0, 20, 3.0, 18.0, 3.1, 151.0 },
			{ 2.0, 2.0, 6.0, 20, 3.0, 19.0, 4.0, 150.0 }, { 2.0, 2.7, 5.0, 22, 3.0, 18.0, 4.0, 145.0 } };
	double test2[][] = // suer
	{ { 12.0, 2.5, 5.0, 30, 13.0, 18.0, 4.0, 10.0 }, { 10.0, 2.0, 4.0, 30, 13.0, 19.0, 3.5, 12.0 },
			{ 12.0, 2.5, 5.0, 33, 13.0, 19.0, 4.0, 10.0 }, { 9.0, 3.0, 5.0, 30, 13.0, 18.0, 3.1, 11.0 },
			{ 11.0, 2.0, 6.0, 30, 13.0, 19.0, 4.0, 10.0 }, { 12.0, 2.7, 5.0, 31, 13.0, 18.0, 4.0, 12.0 } };
	double test3[][] = // suer
	...
	double test4[][] = { { 412.0, 2.5, 5.0, 30, 400.0, 18.0, 41.0, 14.0 },
			{ 412.0, 2.0, 8.0, 30, 413.0, 19.0, 43.5, 12.0 }, { 400.0, 1.5, 5.0, 30, 413.0, 19.0, 44.0, 9.0 },
			{ 412.0, 3.0, 3.0, 30, 413.0, 18.0, 43.1, 11.0 }, { 412.0, 2.0, 6.0, 30, 433.0, 19.0, 44.0, 15.0 },
			{ 400.0, 1.7, 9.0, 30, 433.0, 28.0, 40.0, 12.0 } };
	double train[][][] = {
			{// user0
			{ 1.0, 2.5, 5.0, 10, 3.0, 8.0, 4.0, 50.0 }, { 1.0, 2.0, 4.0, 10, 3.0, 9.0, 3.5, 52.0 },
					{ 1.0, 2.5, 5.0, 10, 3.0, 9.0, 4.0, 40.0 }, { 1.0, 3.0, 5.0, 10, 3.0, 10.0, 3.1, 51.0 },
					{ 1.0, 2.0, 6.0, 10, 3.0, 9.0, 4.0, 50.0 }, { 1.0, 2.7, 5.0, 10, 3.0, 8.0, 4.0, 59.0 } },
			{// user1
			{ 2.0, 2.5, 5.0, 20, 3.0, 18.0, 4.0, 150.0 }, { 2.0, 2.0, 4.0, 20, 3.0, 19.0, 3.5, 152.0 },
					{ 2.0, 2.5, 5.0, 20, 3.0, 19.0, 4.0, 150.0 }, { 2.0, 3.0, 5.0, 20, 3.0, 18.0, 3.1, 151.0 },
					{ 2.0, 2.0, 6.0, 20, 3.0, 19.0, 4.0, 150.0 }, { 2.0, 2.7, 5.0, 20, 3.0, 18.0, 4.0, 152.0 } },
			{// user2
			{ 12.0, 2.5, 5.0, 30, 13.0, 18.0, 4.0, 10.0 }, { 12.0, 2.0, 4.0, 30, 13.0, 19.0, 3.5, 12.0 },
					...
					{ 12.0, 2.0, 6.0, 30, 13.0, 19.0, 4.0, 10.0 }, { 12.0, 2.7, 5.0, 30, 13.0, 18.0, 4.0, 12.0 } },
			{// user3
			{ 312.0, 2.5, 5.0, 30, 313.0, 18.0, 4.0, 310.0 }, { 312.0, 2.0, 4.0, 30, 313.0, 19.0, 3.5, 312.0 },
					...
					{ 312.0, 2.0, 6.0, 30, 313.0, 19.0, 4.0, 310.0 }, { 312.0, 2.7, 5.0, 30, 313.0, 18.0, 4.0, 312.0 } },
			{// user4
			{ 412.0, 2.5, 5.0, 30, 413.0, 18.0, 44.0, 10.0 }, { 412.0, 2.0, 4.0, 30, 413.0, 19.0, 43.5, 12.0 },
					...
					{ 412.0, 2.0, 6.0, 30, 413.0, 19.0, 44.0, 10.0 }, { 412.0, 2.7, 5.0, 30, 413.0, 18.0, 44.0, 12.0 } },
			{// user5
			{ 152.0, 52.5, 55.0, 30, 13.0, 18.0, 4.0, 10.0 }, { 152.0, 52.0, 54.0, 30, 13.0, 19.0, 3.5, 12.0 },
					...
					{ 152.0, 52.0, 56.0, 30, 13.0, 19.0, 4.0, 10.0 }, { 152.0, 52.7, 55.0, 30, 13.0, 18.0, 4.0, 12.0 } },
			{// suer6
			{ 162.0, 2.5, 56.0, 30, 13.0, 18.0, 64.0, 10.0 }, { 162.0, 2.0, 46.0, 30, 13.0, 19.0, 63.5, 12.0 },
					...
					{ 162.0, 2.0, 66.0, 30, 13.0, 19.0, 64.0, 10.0 }, { 162.0, 2.7, 56.0, 30, 13.0, 18.0, 64.0, 12.0 } },
			{// user7
			{ 12.0, 72.5, 5.0, 30, 13.0, 18.0, 74.0, 170.0 }, { 12.0, 72.0, 4.0, 30, 19.0, 19.0, 73.5, 172.0 },
					...
					{ 12.0, 72.0, 6.0, 30, 13.0, 19.0, 74.0, 170.0 }, { 12.0, 72.7, 5.0, 30, 13.0, 18.0, 74.0, 172.0 } },
			{// user8
			{ 12.0, 82.5, 5.0, 30, 823.0, 11.0, 42.0, 180.0 }, { 12.0, 82.0, 4.0, 30, 813.0, 19.0, 32.5, 182.0 },
					{ 12.0, 85.5, 5.0, 30, 823.0, 20.0, 42.0, 180.0 },
					{ 12.0, 83.0, 6.0, 30, 813.0, 18.0, 32.1, 188.0 },
					{ 12.0, 82.0, 6.0, 30, 813.0, 19.0, 42.0, 180.0 },
					{ 12.0, 82.7, 5.0, 30, 823.0, 21.0, 42.0, 182.0 } }, };
	// ///////////////////////////////////////////////////////////////////////////////////
}
